...
class OwnerOrderAdapter(private val ctx : Context, private var orderList:ArrayList<OwnerOrderModel> ):RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.cancel.setOnClickListener{
            db.collection("Orders").document(orderobj.id).update("status", "Cancelled")
                .addOnSuccessListener { Log.d("TAG", "DocumentSnapshot successfully written!")
